    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="product.code"
                    ),
                ),
                (
                    "product",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="codes", through="product.ProductCode", to="product.code"
            ),
        ),
        migrations.AddField(
            model_name="product",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("product", "user"), name="unique productfeedbacks"
            ),
        ),
        migrations.AddConstraint(
            model_name="productcode",
            constraint=models.UniqueConstraint(
                fields=("product", "code"), name="unique_product_code"
            ),
        ),
    ]
